...
<form name="registerform" id="registerform" action="%s" method="post">
	...
	<p>
		<label>
			<input type="checkbox" name="valid_cgv" required/> en cochant cette case vous confirmez avoir pris connaissance du <a href="#">règlement de notre site</a>
		</label>
	</p>
	...
	<p class="nav">
		<a class="simplemodal-login" href="%s">%s</a>',
				__('Un mot de passe vous sera envoyé par email.', 'simplemodal-login'),
				__('Register', 'simplemodal-login'),
				__('Cancel', 'simplemodal-login'),
